...
export const hiragana = {
  gojuon: [
    ...
    { kana: 'わ', romaji: ['wa'] }, { kana: 'を', romaji: ['wo', 'o'] },
    { kana: 'ん', romaji: ['n'] }
  ],
  dakuon: [
  ...
  yoon: [
    ...
    { kana: 'ちゃ', romaji: ['cha', 'tya'] }, { kana: 'ちゅ', romaji: ['chu', 'tyu'] }, { kana: 'ちょ', romaji: ['cho', 'tyo'] },
    ...
    { kana: 'ぢゃ', romaji: ['ja', 'dya'] }, { kana: 'ぢゅ', romaji: ['ju', 'dyu'] }, { kana: 'ぢょ', romaji: ['jo', 'dyo'] },
...
export const katakana = {
  gojuon: [
    ...
    { kana: 'ワ', romaji: ['wa'] }, { kana: 'ヲ', romaji: ['wo', 'o'] },
    { kana: 'ン', romaji: ['n'] }
  ],
  dakuon: [
  ...
  yoon: [
    ...
    { kana: 'チャ', romaji: ['cha', 'tya'] }, { kana: 'チュ', romaji: ['chu', 'tyu'] }, { kana: 'チョ', romaji: ['cho', 'tyo'] },
    ...
    { kana: 'ジャ', romaji: ['ja', 'zya'] }, { kana: 'ジュ', romaji: ['ju', 'zyu'] }, { kana: 'ジョ', romaji: ['jo', 'zyo'] },
    { kana: 'ヂャ', romaji: ['ja', 'dya'] }, { kana: 'ヂュ', romaji: ['ju', 'dyu'] }, { kana: 'ヂョ', romaji: ['jo', 'dyo'] },
...
export const kanaGroups = [
  { id: 'gojuon', name: 'Gojuon (あ, か, さ...)' },
  { id: 'dakuon', name: 'Dakuon (が, ざ, だ...)' },
  { id: 'handakuon', name: 'Handakuon (ぱ, ぴ, ぷ...)' },
  { id: 'yoon', name: 'Yoon (きゃ, しゃ, ちゃ...)' }
];
